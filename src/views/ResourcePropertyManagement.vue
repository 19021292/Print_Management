<template>
  <div>
    ...
    <div class="actions-bar">
      <a-button type="primary" @click="showCreateModal" class="action-button">Thêm thuộc tính</a-button>
...
export default {
  ...
  data() {
    return {
      ...
      detailRules: { // Rules for the new detail form
        propertyId: [{ required: true, message: 'Vui lòng nhập Property ID!' }],
        propertyDetailName: [{ required: true, message: 'Vui lòng nhập tên chi tiết thuộc tính!' }],
  ...
  methods: {
    ...
    showCreateDetailModal() {
      this.detailFormData = { propertyId: null, propertyDetailName: '', image: '', price: null, quantity: null };
